  ...
  <div className="container pt-5">
    <div className="row pt-5 text-center">
      <div className="col-6 col-md-3">
        <img className="img-fluid img-art" alt="cloud" src={cloudSvg} />
        <div className="py-4">
          <h2>Maintenance</h2>
      ...
      <div className="col-6 col-md-3">
        <img className="img-fluid img-art" alt="coding" src={toolSvg} />
        <div className="py-4">
          <h2>Development</h2>
      ...
      <div className="col-6 col-md-3">
        <img className="img-fluid img-art" alt="design" src={penToolSvg} />
        <div className="py-4">
          <h2>Design</h2>
      ...
      <div className="col-6 col-md-3">
        <img className="img-fluid img-art" alt="mentorship" src={bookSvg} />
        <div className="py-4">
          <h2>Mentorship</h2>
          <p>
